...
val IcCheckDark: ImageVector
  get() = ImageVector.Builder(
    ...
    path(
      ...
      moveTo(8.33333f, 15f)
      curveTo(10.1944f, 15f, 11.7708f, 14.3542f, 13.0625f, 13.0625f)
      curveTo(14.3542f, 11.7708f, 15f, 10.1944f, 15f, 8.33333f)
      curveTo(15f, 6.47222f, 14.3542f, 4.89583f, 13.0625f, 3.60417f)
      curveTo(11.7708f, 2.3125f, 10.1944f, 1.66667f, 8.33333f, 1.66667f)
      curveTo(6.47222f, 1.66667f, 4.89583f, 2.3125f, 3.60417f, 3.60417f)
      curveTo(2.3125f, 4.89583f, 1.66667f, 6.47222f, 1.66667f, 8.33333f)
      curveTo(1.66667f, 10.1944f, 2.3125f, 11.7708f, 3.60417f, 13.0625f)
      curveTo(4.89583f, 14.3542f, 6.47222f, 15f, 8.33333f, 15f)
      close()
    }
  }.build()
